...
import 'package:localserver_video_player/Map/folder_pck.dart';
import 'package:localserver_video_player/Map/join_usr_akses.dart';
import 'package:localserver_video_player/Map/user_access.dart';
import 'package:localserver_video_player/User/profile.dart';
import 'package:localserver_video_player/User/sub_folder.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<List> getUser() async {
    ...
    final response = await http.get(Uri.parse(
        "http://timothy.buzz/video_pi/user_account/join_user_akses.php"));
  ...
  Future<List> getDataFolder() async {
    final response = await http
        .get(Uri.parse("http://timothy.buzz/video_pi/get_folder.php"));
    final responseJson = json.decode(response.body);
    setState(() {
      for (Map Data in responseJson) {
  ...
  Future<List<Folder>> getData() async {
    final response =
        await http.get(Uri.parse("http://192.168.100.200/access1/scan.php"));
    final responseJson = json.decode(response.body);
    setState(() {
      for (Map Data in responseJson) {

...
import 'package:localserver_video_player/Map/test.dart';
...
class Ac_Mgm_Admin_Edit_CheckBoxState
  ...
  void hasil() {
    var url_hapus = Uri.parse(
        "http://timothy.buzz/video_pi/user_account/delete_user_akses.php");
    var url_tambah = Uri.parse(
        "http://timothy.buzz/video_pi/user_account/add_user_akses.php");
                        ...
                        child: ListView.builder(
                            ...
                            itemBuilder: (builder, index) {
                              return new CheckboxListTile(
                                ...
                                value:
                                    _selectedId.contains(data_full[index].id),
                                onChanged: (bool selected) {
                                  _onCategorySelected(
                                      selected, (data_full[index].id));
                                },
                              );
                            },

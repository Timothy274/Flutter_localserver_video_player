...
import 'package:localserver_video_player/Admin/Folder_Mgm_Add.dart';
import 'package:localserver_video_player/Admin/Folder_Mgm_Edit.dart';
                              ...
                              onTap: () => Navigator.of(context).push(
                                  new MaterialPageRoute(
                                      builder: (BuildContext context) =>
                                          new Folder_Mgm__Edit_Admin(
                                              dataFolder[index].id,
                                              dataFolder[index].name,
                                              dataFolder[index].path))),
                              child: LimitedBox(
                                maxHeight: 150,
                                child: Container(
